...
$email_subject = "Mensaje de Contacto para CompumundoHipermegarred proveniente de: $name";
$email_body = "Has recibido un mensaje de la página CompumundoHipermegarred.\n\n" . "Detalles del mensaje:\n\nNombre: $name\n\nDirección de Correo Electrónico: $email_address\n\nTeléfono: $phone\n\nMensaje:\n$message";
